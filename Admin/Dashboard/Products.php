                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border ui-sortable-handle" style="cursor: move;">
                                <h3 class="box-title">محصولاتی که به تازگی اضاه شدند</h3>
                                ...
                                <ul class="products-list product-list-in-box">
                                    <li class="item">
                                        ...
                                        <div class="product-info">
                                            <a href="javascript::;" class="product-title">Samsung TV <span class="label label-warning pull-right">تومان1800</span></a>
                                    ...
                                    <li class="item">
                                        ...
                                        <div class="product-info">
                                            <a href="javascript::;" class="product-title">Bicycle <span class="label label-info pull-right">تومان700</span></a>
                                            <span class="product-description">
                                    ...
                                    <li class="item">
                                        ...
                                        <div class="product-info">
                                            <a href="javascript::;" class="product-title">Xbox One <span class="label label-danger pull-right">تومان350</span></a>
                                            <span class="product-description">
                                    ...
                                    <li class="item">
                                        ...
                                        <div class="product-info">
                                            <a href="javascript::;" class="product-title">PlayStation 4 <span class="label label-success pull-right">تومان399</span></a>
                                            <span class="product-description">
                            ...
                            <div class="box-footer text-center">
                                <a href="javascript::;" class="uppercase">مشاهده تمام محصولات</a>
                            </div><!-- /.box-footer -->
                        </div>
